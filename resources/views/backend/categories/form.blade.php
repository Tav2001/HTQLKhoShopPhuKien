    ...
    <div class="box-body">
        <div class="form-group {{ $errors->has('c_code') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12" style="display: inline-block; padding: 0px;">
                <input class="form-control random_code" id="random_code" oninput="if(value.length>15)value=value.slice(0,15)" name="c_code" value="{{ old('c_code', isset($category) ? $category->c_code : '') }}" type="text" placeholder="VD : XX">
            </div>
