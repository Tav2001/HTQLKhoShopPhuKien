    ...
    <div class="box-body">
        <div class="form-group {{ $errors->has('s_code') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12" style="display: inline-block; padding: 0px;">
                <input class="form-control random_code" id="random_code" oninput="if(value.length>15)value=value.slice(0,15)" name="s_code" value="{{ old('s_code', isset($supplier) ? $supplier->s_code : '') }}" type="text" placeholder="Mã khách hàng">
            </div>
        ...
        <div class="form-group {{ $errors->has('s_phone') ? 'has-error' : '' }}">
            ...
            <input type="text" class="form-control" name="s_phone" value="{{ old('s_phone', isset($supplier) ? $supplier->s_phone : '') }}" placeholder="0xxxxxxxxx">
