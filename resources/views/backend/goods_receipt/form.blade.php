    ...
    <div class="box-body">
        <div class="form-group {{ $errors->has('w_code') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12" style="display: inline-block; padding: 0px;">
                <input class="form-control random_code" id="random_code" oninput="if(value.length>15)value=value.slice(0,15)" name="w_code" value="{{ old('w_code', isset($warehousing) ? $warehousing->w_code : '') }}" type="text" placeholder="Mã đơn hàng (XH_)" required>
            </div>
            ...
            <tbody class="content-table">
                @if (!isset($warehousing))
                    <tr location="0" class="product_0">
                        ...
                        <td>
                            <input type="number" class="form-control pw_total_number" name="pw_total_number[0]" value="" placeholder="Số lượng" required min="1">
                        </td>
                        <td>
