...
<head>
    ...
    <title>@yield('title','Quản Lý Phụ Kiện')</title>
...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="/qlphukien/public/system" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>Q</b>L</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">QUẢN LÝ PHỤ KIỆN</span>
        </a>
        ...
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree" style="margin-top: 20px;">
                ...
                <li class="treeview {!! (isset($c_menu) || isset($unit_menu) || isset($pro_menu))  ? 'active menu-open' : '' !!} " style="height: auto;">
                    <a href="#">
                        <i class="fa fa-fw fa-database"></i> <span>Dữ liệu hàng hóa</span>
                    ...
                    <ul class="treeview-menu" style="display: {!! (isset($c_menu) || isset($unit_menu) || isset($pro_menu)) ? 'block' : 'none' !!}">
                        ...
                        <li {!! isset($pro_menu) ? "class='active'" : '' !!}><a href="{!! route('get.list.products') !!}"><i class="fa fa-circle-o"></i> <span>Hàng hóa</span></a></li>
                    </ul>
                </li>
                ...
                <li class="treeview {!! (isset($import_menu) || isset($import_list_product))   ? 'active menu-open' : '' !!}"  style="height: auto;">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li {!! isset($import_list_product) ? "class='active'" : '' !!}><a href="{{ route('get.list.product.goods_issue') }}"><i class="fa fa-circle-o"></i> <span>Hàng hóa đã nhập</span></a></li>
                    </ul>
                </li>
                <li class="treeview {!! (isset($export_menu) || isset($export_list_product))   ? 'active menu-open' : '' !!}" style="height: auto;">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li {!! isset($export_list_product) ? "class='active'" : '' !!}><a href="{!! route('get.list.export.product.goods_issue') !!}"><i class="fa fa-circle-o"></i> <span>Hàng hóa đã xuất</span></a></li>
                    </ul>
                </li>
                ...
                <li {!! isset($statistical) ? "class='active'" : '' !!}><a href="{!! route('statistical') !!}"><i class="fa fa-fw fa-pie-chart"></i> <span>Thống kê nhập xuất</span></a></li>
